...
export const T = {
  zh: {
    sysTitle: "Finished Goods Warehouse", sysSub: "I/O Management",
    ...
    // History & Live Monitor Keys
    historySearchPlaceholder: "搜尋姓名、工號、部門...",
    searchBtn: "搜尋",
    exportBtn: "匯出 Excel",
    refreshBtn: "重新整理",
    loadingHistory: "正在載入歷史紀錄...",
    noHistoryFound: "查無歷史紀錄。",
    loadingMonitor: "正在載入即時監控數據...",
    stt: "序號",
    company: "公司",
    userId: "工號",
    fullName: "姓名",
    ...
    checkoutFailed: "簽退失敗。",
    transactionIdMissing: "缺少交易 ID。",
    confirmCheckoutTitle: "確認簽退？",
    confirmOk: "確認",
    confirmCancel: "取消",
    checkingOut: "正在簽退...",
    photoPreview: "照片預覽",
    ...
    checkInBtn: "+ 簽入",
    totalRecords: "總進出記錄",
    securedWhitelistRoster: "安全白名單名冊",
    loginCardNumber: "卡號",
    loginUserId: "工號 / ID",
    loginPassword: "密碼",
    placeholderScanCard: "感應卡片",
    placeholderEnterUserId: "輸入工號",
    placeholderEnterPassword: "輸入密碼",
    btnSignIn: "登入",
    btnAuthenticating: "正在驗證...",
    btnUseUserId: "使用工號登入",
    btnScanToLogin: "感應卡片登入",
    captchaLabel: "驗證碼",
    placeholderEnterCaptcha: "輸入驗證碼",
    refreshCaptcha: "重新產生",
    captchaRequired: "請輸入驗證碼",
    captchaMismatch: "驗證碼錯誤，請重新輸入",
    loginError: "登入失敗",
  },
  en: {
    sysTitle: "Finished Goods Warehouse", sysSub: "I/O Management",
    ...
    // History & Live Monitor Keys
    historySearchPlaceholder: "Search name, code, dept...",
    searchBtn: "Search",
    exportBtn: "Export Excel",
    refreshBtn: "Refresh",
    loadingHistory: "Loading history records...",
    noHistoryFound: "No history records found.",
    loadingMonitor: "Loading live monitor data...",
    stt: "STT",
    company: "Company",
    userId: "User ID",
    fullName: "Full Name",
    ...
    transactionIdMissing: "Transaction ID is missing.",
    ...
    securedWhitelistRoster: "Secured Whitelist Roster",
    loginCardNumber: "Card Number",
    loginUserId: "User ID",
    loginPassword: "Password",
    placeholderScanCard: "Scan card",
    placeholderEnterUserId: "Enter User ID",
    placeholderEnterPassword: "Enter password",
    btnSignIn: "Sign In",
    btnAuthenticating: "Authenticating...",
    btnUseUserId: "Use User ID",
    btnScanToLogin: "Scan to login",
  ...
  vi: {
    ...
    // History & Live Monitor Keys
    historySearchPlaceholder: "Tìm kiếm tên, mã, bộ phận...",
    searchBtn: "Tìm kiếm",
    exportBtn: "Xuất Excel",
    refreshBtn: "Làm mới",
    loadingHistory: "Đang tải dữ liệu lịch sử...",
    noHistoryFound: "Không tìm thấy dữ liệu lịch sử.",
    loadingMonitor: "Đang tải dữ liệu giám sát...",
    stt: "STT",
    company: "Công ty",
    userId: "Mã NV",
    fullName: "Họ Tên",
    cardNumber: "Số Thẻ",
    userType: "Loại đối tượng",
    ...
    entryTime: "Giờ Vào",
    stayTime: "Thời Gian Ở",
    checkoutSuccess: "Xác nhận ra kho thành công.",
    checkoutFailed: "Xác nhận ra kho thất bại.",
    transactionIdMissing: "Thiếu mã giao dịch (Transaction ID).",
    confirmCheckoutTitle: "Xác nhận ra kho?",
    confirmOk: "Xác nhận",
    confirmCancel: "Hủy",
    checkingOut: "Đang Đăng Ký Ra...",
    photoPreview: "Xem Ảnh",
    view: "Xem",
    logoutBtn: "Đăng xuất",
    checkInBtn: "+ Đăng ký vào",
    totalRecords: "Tổng lượt vào ra",
    securedWhitelistRoster: "Whitelist",
    loginCardNumber: "Số thẻ",
    loginUserId: "Mã nhân viên",
    loginPassword: "Mật khẩu",
    placeholderScanCard: "Quét thẻ",
    placeholderEnterUserId: "Nhập mã nhân viên",
    placeholderEnterPassword: "Nhập mật khẩu",
    btnSignIn: "Đăng nhập",
    btnAuthenticating: "Đang xác thực...",
    btnUseUserId: "Đăng nhập bằng mã nhân viên",
    btnScanToLogin: "Quét thẻ để đăng nhập",
    captchaLabel: "Captcha",
    placeholderEnterCaptcha: "Nhập captcha",
    refreshCaptcha: "Tạo lại",
    captchaRequired: "Vui lòng nhập captcha",
    captchaMismatch: "Captcha không đúng",
