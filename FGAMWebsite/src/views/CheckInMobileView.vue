...
const userTypeItems = [
  { userTypeId: '1', userTypeName: 'nhân viên' },
  { userTypeId: '2', userTypeName: 'nhà cung cấp' },
  { userTypeId: '3', userTypeName: 'khách hàng' },
  { userTypeId: '4', userTypeName: 'kiểm toán' }
]

const purposeItems = [
  { purposeId: '1', purposeName: 'làm việc' },
  { purposeId: '2', purposeName: 'giao hàng' },
  { purposeId: '3', purposeName: 'kiểm toán' },
  { purposeId: '4', purposeName: 'họp' }
]
...
function handleCardLookup() {
  if (!checkInCardNumber.value.trim()) return
...
function handleManualNext() {
  if (manualStep.value === 1 && !formState.value.cardNumber.trim()) return
  manualStep.value += 1
}
...
function selectUserType(id) {
  formState.value.userTypeId = id
}

function selectPurpose(name) {
  formState.value.purposeName = name
}
</script>
                  ...
                  <div class="flex gap-3 relative w-full items-center">
                    <div class="relative flex items-center flex-1">
                      <input
                        ...
                        placeholder="Quét hoặc nhập số thẻ để check-in"
                      />
